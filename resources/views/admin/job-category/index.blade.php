...
@section('content')
    ...
    <!-- ROW-1 OPEN-->
        ...
        <div class="col-md-12 col-lg-12">
            ...
            <a href="{{ route('dashboard.job-category.create') }}" class="btn btn-info-light ">
                ...
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{--<a class="btn btn-sm btn-primary" href=""><i class="fa fa-eye"></i></a>--}}
                                             ...
                                             <a class="btn btn-sm btn-secondary" href="{{ route('dashboard.job-category.edit', $item->id) }}"><i class="fa fa-edit"></i> </a>

                                            @endcan
                                            @can('permission_delete')

                                                <form action="{{ route('dashboard.job-category.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Are you sure');" style="display: inline-block;">
                    ...
                    <div id="pagination">{{{ $job_cate->links() }}}</div>
